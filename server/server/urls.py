...
urlpatterns = patterns('',
    ...
    url(r'^dev/datatypes$', 'copperfish.views.datatypes', name='datatypes'),
    url(r'^dev/datatypes/(?P<id>\d+)/$', 'copperfish.views.datatype_detail', name='datatype_detail'),
    url(r'dev/datatype_add$', 'copperfish.views.datatype_add', name='datatype_add'),
    ...
    url(r'dev/resources$', 'copperfish.views.resources', name='resources'),
    url(r'dev/resource_add$', 'copperfish.views.resource_add', name='resource_add'),
    
    url(r'^usr$', 'copperfish.views.usr', name='usr'),
    url(r'^usr/datasets', 'copperfish.views.datasets', name='datasets'),
)
