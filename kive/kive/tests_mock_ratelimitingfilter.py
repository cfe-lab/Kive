...
from kive.ratelimitingfilter import RateLimitingFilter


class RateLimitingFilterTest(TestCase):
    def setUp(self):
        patcher = patch('kive.ratelimitingfilter.time')
    ...
    def test_limit_to_one_record_per_two_seconds_over_four_seconds(self):
        """ Fractional rates aren't rounded. """
