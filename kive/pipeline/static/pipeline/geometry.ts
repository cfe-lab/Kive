...
export class Geometry {
    ...
    static isometricXCoord(x: number, y: number): number {
        ...
        // using a -30° line that intersects (0,0) and a 30° line that intersects (x,y), find the intersection of
        // the two. then compute the distance from this intersection to (x,y). tan(pi/6) = 1/sqrt(3) ~ 0.577350269
