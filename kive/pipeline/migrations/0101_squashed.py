# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-06-13 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('output_cdt', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cables_leading_to', to='metadata.CompoundDatatype')),
                ('pipeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcables', to='pipeline.Pipeline')),
                ('source', models.ForeignKey(help_text='Source output hole', on_delete=django.db.models.deletion.CASCADE, to='transformation.TransformationOutput')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outputs_to_delete', models.ManyToManyField(help_text='TransformationOutputs whose data should not be retained', related_name='pipeline_steps_deleting', to=b'transformation.TransformationOutput')),
                ('pipeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='pipeline.Pipeline')),
                ('transformation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pipelinesteps', to='transformation.Transformation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dest', models.ForeignKey(help_text='Wiring destination input hole', on_delete=django.db.models.deletion.CASCADE, related_name='cables_leading_in', to='transformation.TransformationInput')),
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transformation.TransformationXput')),
            ],
            bases=('pipeline.pipelinecable',),
        ),
