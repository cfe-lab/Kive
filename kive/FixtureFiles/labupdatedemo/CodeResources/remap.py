...
from kive.FixtureFiles.labupdatedemo.CodeResources import project_config
from kive.FixtureFiles.labupdatedemo.CodeResources.settings import bowtie_threads, consensus_q_cutoff,\
